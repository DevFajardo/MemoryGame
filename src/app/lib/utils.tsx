...
export  const logicGame =(cards: CardType[], card:CardType, isDisabled: boolean, flippedCards:CardType[], setCards: Function, setFlippedCards:Function, setIsDisabled:Function, setPoints:Function, points: number) => {
  ...
  export const resetGame = (cards: CardType[], setCards: Function, setPoints : Function) => {
